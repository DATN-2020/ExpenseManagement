...
//            mHighlightPaint.setColor(set.getHighLightColor());
            ...
            if(high.getY()>0){
                int color = new AndroidResourceManager().getColor(R.color.color_399b54);
                mHighlightPaint.setColor(color);
                setHighlightDrawPos(high, mBarRect);
            }else if(high.getY()<0){
                int color = new AndroidResourceManager().getColor(R.color.color_e94c4c);
                mHighlightPaint.setColor(color);
                setHighlightDrawPos(high, mBarRect);
            }
    ...
    protected void setHighlightDrawPos(Highlight high, RectF bar) {
        high.setDraw(bar.centerX(), bar.bottom);
    }

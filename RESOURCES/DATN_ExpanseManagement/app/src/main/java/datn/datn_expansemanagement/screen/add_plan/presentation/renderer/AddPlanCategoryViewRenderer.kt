...
class AddPlanCategoryViewRenderer(context: Context) : ViewRenderer<AddPlanCategoryViewModel>(context) {
    override fun getLayoutId(): Int {
        return R.layout.item_layout_add_plan_date
    }

    override fun getModelClass(): Class<AddPlanCategoryViewModel> = AddPlanCategoryViewModel::class.java
